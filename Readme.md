...
* All work has been implemented individually
* The solutions are written with a focus on clarity and understanding
* Each use case will be maintained in its respective folder
